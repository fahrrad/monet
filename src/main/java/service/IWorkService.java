...
public interface IWorkService {
	 ...
	 * 
	 * @param name the name of the work you want to look for
	 * @return a list of works that go by the name you looked for, or an empty list if none were found
	 */
	public List<Work> getByName(String name);
	
	/**
	 * saves a work, either by creating it ( if the id is not in the database ), or saving it
	 * @param work
	 * @return 
	 */
